...
--- 
Es gibt keine standardisierte Ordnerstruktur in React, es gibt auch kein Falsch und kein richtig. Dennoch ist es wichtig eine gute Lösung zu finden, die auch zu einem passt.
Es gibt ein paar Ordnerstrukturen, welche oft verwendet werden und gewisse Vorteile bieten.

##### BulletProof Ordnerstruktur ([BulletProof](https://rikiphukon.medium.com/how-i-structure-my-react-projects-as-a-frontend-developer-22bd18e83f5b))
Der Hauptpunkt von dieser Ordnerstruktur ist es die **Geschäftsdomäne** (Features) von dem **Shared** Code zu trennen. Es verfolgt das "Seperation of Concern Prinzip".

Separation of Concerns bedeutet:
